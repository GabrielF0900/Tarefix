...
function validacaoRegistro({data}: {data: z.infer<typeof registrationSchema>}) {

  //Validando os datos de registro.
  const result = registrationSchema

  if(!name || !email || !password) {
    throw new Error("Todos os campos são obrigatórios");
  } 

  //Fazendo regex para validar email
