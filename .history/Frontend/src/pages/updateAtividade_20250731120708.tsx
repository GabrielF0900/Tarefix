...
export default function EditarTarefa() {
  return (
    <div className="min-h-screen bg-[#0e1628] text-white p-2 sm:p-4 md:p-10">
      {/* Top Bar */}
      ...
      {/* Form Container */}
      <div className="bg-[#1b2436] p-4 sm:p-6 rounded-2xl shadow-md max-w-3xl mx-auto space-y-6">
        ...
        <div className="relative">
          <input type="date" className="w-full bg-[#2c3a54] p-2 rounded-lg pr-10 text-base" value="2025-07-28" />
      ...
      {/* Info Extra */}
      <div className="bg-[#1b2436] p-2 sm:p-4 mt-6 rounded-2xl max-w-3xl mx-auto text-xs sm:text-sm text-gray-300 flex flex-col sm:flex-row justify-between gap-2 sm:gap-4">
